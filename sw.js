const CACHE_NAME = "portable-pdf-reader-v106";
const APP_SHELL = [
  "./",
  "./index.html",
  "./styles.css?v=106",
  ...
  "./src/encryption.js?v=106",
  "./src/encrypted-backups.js?v=106",
  "./src/pdf-sources.js?v=106",
  "./src/utils.js?v=106",
  ...
  "./vendor/pdfjs/pdf.worker.mjs?v=106",
