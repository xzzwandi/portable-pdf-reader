const CACHE_NAME = "portable-pdf-reader-v107";
const APP_SHELL = [
  "./",
  "./index.html",
  "./styles.css?v=107",
  ...
  "./src/encryption.js?v=107",
  "./src/encrypted-backups.js?v=107",
  "./src/pdf-sources.js?v=107",
  "./src/utils.js?v=107",
  ...
  "./vendor/pdfjs/pdf.worker.mjs?v=107",
