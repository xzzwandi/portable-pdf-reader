...
一个静态网页版 PDF 阅读器，适合在 iPhone Chrome 或 Safari 里使用。
...
```text
http://127.0.0.1:5174/?v=15
```

## iPhone 使用

部署到 HTTPS 地址后，用手机 Chrome 或 Safari 打开网页，点「打开 PDF」，从“文件”App 里选择 PDF。

如果想添加到主屏幕，建议用 Safari 打开 HTTPS 地址，再点分享按钮，选择“添加到主屏幕”。

## 注意

- PDF 保存在当前浏览器对这个网址的本地存储里，不会自动上传。
- 换浏览器、换网址、清理浏览器网站数据后，已保存的 PDF 可能不可见。
